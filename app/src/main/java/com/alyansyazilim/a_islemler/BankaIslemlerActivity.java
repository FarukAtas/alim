...
public class BankaIslemlerActivity extends Activity {
    private static final String[] fields = {K.idColumn, "zaman", "bankod", "tutar", "ack"};
    ...
    public void doLoadView() {
        OdmBankaIslem islem = new OdmBankaIslem(this);
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setTitle(R.string.title_activity_banka_islemler);
        ...
        this.view.setOnCreateContextMenuListener(new View.OnCreateContextMenuListener() { // from class: com.alyansyazilim.a_islemler.BankaIslemlerActivity.1
            @Override // android.view.View.OnCreateContextMenuListener
            public void onCreateContextMenu(ContextMenu menu, View v, ContextMenu.ContextMenuInfo menuInfo) {
                if (v.getId() == R.id.listView1) {
                    menu.setHeaderTitle("İşlem seç");
                    String[] menuItems = BankaIslemlerActivity.this.getResources().getStringArray(R.array.popup_bankaislem);
        ...
        this.view.setOnItemClickListener(new AdapterView.OnItemClickListener() { // from class: com.alyansyazilim.a_islemler.BankaIslemlerActivity.2
    ...
    private void setButtons(final EditText edBul) {
        ...
        btnBul.setOnClickListener(new View.OnClickListener() { // from class: com.alyansyazilim.a_islemler.BankaIslemlerActivity.3
            @Override // android.view.View.OnClickListener
            public void onClick(View v) {
                BankaIslemlerActivity.this.doLoadView();
        ...
        btnBack.setOnClickListener(new View.OnClickListener() { // from class: com.alyansyazilim.a_islemler.BankaIslemlerActivity.4
            @Override // android.view.View.OnClickListener
            public void onClick(View v) {
                BankaIslemlerActivity.this.finish();
            }
        });
    }
    ...
    public boolean onContextItemSelected(MenuItem item) {
        ...
        if (item.getTitle().toString().equalsIgnoreCase(getString(R.string.SilStr))) {
            DialogInterface.OnClickListener dcl = new DialogInterface.OnClickListener() { // from class: com.alyansyazilim.a_islemler.BankaIslemlerActivity.5
                @Override // android.content.DialogInterface.OnClickListener
                public void onClick(DialogInterface dialog, int which) {
                    switch (which) {
                        case -1:
                            BankaIslemlerActivity.this.doIslemSil(mdl, id);
                            BankaIslemlerActivity.this.doLoadView();
                            break;
                    }
                }
