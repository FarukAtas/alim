...
public class KasaIslemlerActivity extends Activity {
    private static final String[] fields = {K.idColumn, "zaman", "kaskod", "tutar", "ack"};
    ...
    public void doLoadView() {
        OdmKasaIslem islem = new OdmKasaIslem(this);
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setTitle(R.string.title_activity_kasa_islemler);
        ...
        this.view.setOnCreateContextMenuListener(new View.OnCreateContextMenuListener() { // from class: com.alyansyazilim.a_islemler.KasaIslemlerActivity.1
            @Override // android.view.View.OnCreateContextMenuListener
            public void onCreateContextMenu(ContextMenu menu, View v, ContextMenu.ContextMenuInfo menuInfo) {
                if (v.getId() == R.id.listView1) {
                    menu.setHeaderTitle("İşlem seç");
                    String[] menuItems = KasaIslemlerActivity.this.getResources().getStringArray(R.array.popup_kasaislem);
        ...
        this.view.setOnItemClickListener(new AdapterView.OnItemClickListener() { // from class: com.alyansyazilim.a_islemler.KasaIslemlerActivity.2
    ...
    private void setButtons(final EditText edBul) {
        ...
        btnBul.setOnClickListener(new View.OnClickListener() { // from class: com.alyansyazilim.a_islemler.KasaIslemlerActivity.3
            @Override // android.view.View.OnClickListener
            public void onClick(View v) {
                KasaIslemlerActivity.this.doLoadView();
        ...
        btnBack.setOnClickListener(new View.OnClickListener() { // from class: com.alyansyazilim.a_islemler.KasaIslemlerActivity.4
            @Override // android.view.View.OnClickListener
            public void onClick(View v) {
                KasaIslemlerActivity.this.finish();
            }
        });
    }
    ...
    public boolean onContextItemSelected(MenuItem item) {
        ...
        if (item.getTitle().toString().equalsIgnoreCase(getString(R.string.SilStr))) {
            DialogInterface.OnClickListener dcl = new DialogInterface.OnClickListener() { // from class: com.alyansyazilim.a_islemler.KasaIslemlerActivity.5
                @Override // android.content.DialogInterface.OnClickListener
                public void onClick(DialogInterface dialog, int which) {
                    switch (which) {
                        case -1:
                            KasaIslemlerActivity.this.doIslemSil(mdl, id);
                            KasaIslemlerActivity.this.doLoadView();
                            break;
                    }
                }
