...
public class MotionEventCompat {
    ...
    interface MotionEventVersionImpl {
        int findPointerIndex(MotionEvent motionEvent, int r2);

        int getPointerId(MotionEvent motionEvent, int r2);

        float getX(MotionEvent motionEvent, int r2);

        float getY(MotionEvent motionEvent, int r2);
    }
