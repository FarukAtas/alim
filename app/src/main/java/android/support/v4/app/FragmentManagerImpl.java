...
final class FragmentManagerImpl extends FragmentManager {
    ...
    static boolean HONEYCOMB = false;
    ...
    /* JADX WARN: Removed duplicated region for block: B:31:0x0042 A[FALL_THROUGH, PHI: r12
  0x0042: PHI (r12v5 'newState' int) = 
  (r12v3 'newState' int)
  (r12v3 'newState' int)
  (r12v3 'newState' int)
  (r12v3 'newState' int)
  ...
  (r12v6 'newState' int)
  (r12v6 'newState' int)
 binds: [B:121:0x02bf, B:123:0x02c3, B:125:0x02c9, B:147:0x04a4, B:151:0x04af, B:150:0x04aa, B:133:0x02df, B:30:0x003f, B:111:0x026b, B:119:0x02b5] A[DONT_GENERATE, DONT_INLINE]] */
    /*
        Code decompiled incorrectly, please refer to instructions dump.
        To view partially-correct add '--show-bad-code' argument
    */
    void moveToState(final Fragment r11, int r12, int r13, int r14, boolean r15) {
        /*
    ...
    public void removeFragment(Fragment fragment, int transition, int transitionStyle) {
        ...
        if (!fragment.mDetached || inactive) {
            ...
            moveToState(fragment, inactive ? 0 : 1, transition, transitionStyle, HONEYCOMB);
        }
    }
